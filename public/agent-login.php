	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
		...
		<div class="row">
			<div id="login" class="container col-xl-4 col-lg-5 col-md-6 col-sm-7 col-10 text-center text-light form-group-lg">
				<h2 class="text-info bg-light py-3">Registered Agents only</h2>
				<form action="" method="post" class="form-group">
					<div class="text-danger"><?php if(isset($error_msg)) echo $error_msg; ?></div>
					<div class="form-group">
						<label for="inputEmail">Email address <span class="text-danger"><?php if(isset($error['email'])) echo $error['email'] ?></span></label>
					...
					<fieldset class="form-group">
						<div class="form-check-inline">
							<input  class="form-check-input" type="radio" name="userType" value="User" disabled>
							<label class="form-check-label text-light">User</label>
						</div>
						<div class="form-check-inline">
							<input  class="form-check-input" type="radio" name="userType" value="Agent" checked>
